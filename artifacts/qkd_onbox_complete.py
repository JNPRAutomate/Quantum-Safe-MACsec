...
# All functions migrated from old module scope into classes
# ============================================================================
...
def load_link_state(*args, **kwargs):
    return StateManager.load_link_state(*args, **kwargs)

def save_db_state(*args, **kwargs):
    return StateManager.save_db_state(*args, **kwargs)

def default_keychain_state(*args, **kwargs):
    return StateManager.default_keychain_state(*args, **kwargs)

def keychain_state_valid(*args, **kwargs):
    return StateManager.keychain_state_valid(*args, **kwargs)

def normalize_pending_keys(*args, **kwargs):
    return StateManager.normalize_pending_keys(*args, **kwargs)

def normalize_slot_ring(*args, **kwargs):
    return StateManager.normalize_slot_ring(*args, **kwargs)

def reconcile_state_with_router(*args, **kwargs):
    return StateManager.reconcile_state_with_router(*args, **kwargs)

def load_peer_key_rotation_state(*args, **kwargs):
    return StateManager.load_peer_key_rotation_state(*args, **kwargs)

def save_peer_key_rotation_state(*args, **kwargs):
    return StateManager.save_peer_key_rotation_state(*args, **kwargs)

# RuntimeManager wrappers
def log(*args, **kwargs):
    return RuntimeManager.log(*args, **kwargs)

def rotate_log(*args, **kwargs):
    return RuntimeManager.rotate_log(*args, **kwargs)

def ensure_runtime_dirs(*args, **kwargs):
    return RuntimeManager.ensure_runtime_dirs(*args, **kwargs)

def enforce_runtime_file_permissions(*args, **kwargs):
    return RuntimeManager.enforce_runtime_file_permissions(*args, **kwargs)

def _set_mode_if_needed(*args, **kwargs):
    return RuntimeManager._set_mode_if_needed(*args, **kwargs)

# LockManager wrappers
def acquire_lock(*args, **kwargs):
    return LockManager.acquire_lock(*args, **kwargs)

def release_lock(*args, **kwargs):
    return LockManager.release_lock(*args, **kwargs)

def acquire_action_lock(*args, **kwargs):
    return LockManager.acquire_action_lock(*args, **kwargs)

def release_action_lock(*args, **kwargs):
    return LockManager.release_action_lock(*args, **kwargs)

# PeerTransport wrappers
def scp_upload_text(*args, **kwargs):
    return PeerTransport.scp_upload_text(*args, **kwargs)

def scp_download_text(*args, **kwargs):
    return PeerTransport.scp_download_text(*args, **kwargs)

def send_command(*args, **kwargs):
    return PeerTransport.send_command(*args, **kwargs)

def write_peer_batch_ack(*args, **kwargs):
    return PeerTransport.write_peer_batch_ack(*args, **kwargs)

def read_remote_peer_batch_ack(*args, **kwargs):
    return PeerTransport.read_remote_peer_batch_ack(*args, **kwargs)

def wait_for_peer_batch_ack_payload(*args, **kwargs):
    return PeerTransport.wait_for_peer_batch_ack_payload(*args, **kwargs)

def wait_for_peer_batch_ack(*args, **kwargs):
    return PeerTransport.wait_for_peer_batch_ack(*args, **kwargs)

def ssh_transport_options(*args, **kwargs):
    return PeerTransport.ssh_transport_options(*args, **kwargs)

def validate_ssh_runtime_for_master(*args, **kwargs):
    return PeerTransport.validate_ssh_runtime_for_master(*args, **kwargs)

# MACsecController wrappers
def install_keychain_batch(*args, **kwargs):
    return MACsecController.install_keychain_batch(*args, **kwargs)

def install_keychain_key(*args, **kwargs):
    return MACsecController.install_keychain_key(*args, **kwargs)

def bind_interface_to_stable_ca(*args, **kwargs):
    return MACsecController.bind_interface_to_stable_ca(*args, **kwargs)

def macsec_down(*args, **kwargs):
    return MACsecController.macsec_down(*args, **kwargs)

def macsec_has_inuse_sa(*args, **kwargs):
    return MACsecController.macsec_has_inuse_sa(*args, **kwargs)

def get_configured_active_ca(*args, **kwargs):
    return MACsecController.get_configured_active_ca(*args, **kwargs)

def get_configured_keychain_key_indices(*args, **kwargs):
    return MACsecController.get_configured_keychain_key_indices(*args, **kwargs)

def get_configured_next_pending_slot(*args, **kwargs):
    return MACsecController.get_configured_next_pending_slot(*args, **kwargs)

def get_configured_keychain_entries(*args, **kwargs):
    return MACsecController.get_configured_keychain_entries(*args, **kwargs)

def configured_qkd_keychain_names(*args, **kwargs):
    return MACsecController.configured_qkd_keychain_names(*args, **kwargs)

def existing_qkd_keychain_names(*args, **kwargs):
    return MACsecController.existing_qkd_keychain_names(*args, **kwargs)

def purge_stale_qkd_keychains(*args, **kwargs):
    return MACsecController.purge_stale_qkd_keychains(*args, **kwargs)

def wait_for_macsec_inuse(*args, **kwargs):
    return MACsecController.wait_for_macsec_inuse(*args, **kwargs)

def verify_local_config_state(*args, **kwargs):
    return MACsecController.verify_local_config_state(*args, **kwargs)

def adopt_bootstrap_seed(*args, **kwargs):
    return MACsecController.adopt_bootstrap_seed(*args, **kwargs)

def configured_bootstrap_seed_only(*args, **kwargs):
    return MACsecController.configured_bootstrap_seed_only(*args, **kwargs)

# MKASession wrappers
def get_mka_session_block_for_iface(*args, **kwargs):
    return MKASession.get_mka_session_block_for_iface(*args, **kwargs)

def parse_mka_session_fields(*args, **kwargs):
    return MKASession.parse_mka_session_fields(*args, **kwargs)

def mka_session_secured(*args, **kwargs):
    return MKASession.mka_session_secured(*args, **kwargs)

def mka_ckn_matches(*args, **kwargs):
    return MKASession.mka_ckn_matches(*args, **kwargs)

def mka_confirms_key(*args, **kwargs):
    return MKASession.mka_confirms_key(*args, **kwargs)

def promote_pending_key_if_mka_confirmed(*args, **kwargs):
    return MKASession.promote_pending_key_if_mka_confirmed(*args, **kwargs)

def compare_peer_keychain_state(*args, **kwargs):
    return MKASession.compare_peer_keychain_state(*args, **kwargs)

def peer_states_aligned_strict(*args, **kwargs):
    return MKASession.peer_states_aligned_strict(*args, **kwargs)

# StatusExporter wrappers
def export_peer_status_snapshot(*args, **kwargs):
    return StatusExporter.export_peer_status_snapshot(*args, **kwargs)

def refresh_peer_status_snapshots(*args, **kwargs):
    return StatusExporter.refresh_peer_status_snapshots(*args, **kwargs)

def get_peer_status(*args, **kwargs):
    return StatusExporter.get_peer_status(*args, **kwargs)

# PeerKeyRotation wrappers
def run_peer_key_rotation_cycle(*args, **kwargs):
    return PeerKeyRotation.run_peer_key_rotation_cycle(*args, **kwargs)

def run_slave_install_peer_pubkey(*args, **kwargs):
    return PeerKeyRotation.run_slave_install_peer_pubkey(*args, **kwargs)

def _peer_generate_new_keypair(*args, **kwargs):
    return PeerKeyRotation._peer_generate_new_keypair(*args, **kwargs)

def _peer_distribute_pubkey_to_peer(*args, **kwargs):
    return PeerKeyRotation._peer_distribute_pubkey_to_peer(*args, **kwargs)

def _get_all_junos_auth_keys_for_user(*args, **kwargs):
    return PeerKeyRotation._get_all_junos_auth_keys_for_user(*args, **kwargs)

def _get_junos_auth_keys_for_peer_device(*args, **kwargs):
    return PeerKeyRotation._get_junos_auth_keys_for_peer_device(*args, **kwargs)
...
def bootstrap_keychain_link(*args, **kwargs):
    return MasterOrchestrator.bootstrap_keychain_link(*args, **kwargs)

def resume_inflight_install(*args, **kwargs):
    return MasterOrchestrator.resume_inflight_install(*args, **kwargs)

def select_ring_update_slots(*args, **kwargs):
    return MasterOrchestrator.select_ring_update_slots(*args, **kwargs)

# SlaveOrchestrator wrappers
def parse_slave(*args, **kwargs):
    return SlaveOrchestrator.parse_slave(*args, **kwargs)

def run_slave_install_key(*args, **kwargs):
    return SlaveOrchestrator.run_slave_install_key(*args, **kwargs)

def run_slave_install_key_batch(*args, **kwargs):
    return SlaveOrchestrator.run_slave_install_key_batch(*args, **kwargs)

def run_slave_status(*args, **kwargs):
...
# KMEClient wrappers
def do_enc(*args, **kwargs):
    return KMEClient.do_enc(*args, **kwargs)

def do_dec(*args, **kwargs):
    return KMEClient.do_dec(*args, **kwargs)

def validate_kme_availability(*args, **kwargs):
    return KMEClient.validate_kme_availability(*args, **kwargs)

# Utilities - these go straight from Utilities class
def _print_cli_usage(*args, **kwargs):
    return Utilities._print_cli_usage(*args, **kwargs)

def _early_info_exit(*args, **kwargs):
    return Utilities._early_info_exit(*args, **kwargs)

def _load_json_or_die(*args, **kwargs):
    return Utilities._load_json_or_die(*args, **kwargs)

def _validate_runtime_contract_or_die(*args, **kwargs):
    return Utilities._validate_runtime_contract_or_die(*args, **kwargs)

def stable_ca_name(*args, **kwargs):
    return Utilities.stable_ca_name(*args, **kwargs)

def stable_keychain_name(*args, **kwargs):
    return Utilities.stable_keychain_name(*args, **kwargs)

def link_id(*args, **kwargs):
    return Utilities.link_id(*args, **kwargs)

def validate_link_runtime(*args, **kwargs):
    return Utilities.validate_link_runtime(*args, **kwargs)

def managed_links(*args, **kwargs):
    return Utilities.managed_links(*args, **kwargs)

def link_by_interface(*args, **kwargs):
    return Utilities.link_by_interface(*args, **kwargs)

def now_ms(*args, **kwargs):
    return Utilities.now_ms(*args, **kwargs)

def elapsed_ms(*args, **kwargs):
    return Utilities.elapsed_ms(*args, **kwargs)

def epoch_from_junos_start_time(*args, **kwargs):
    return Utilities.epoch_from_junos_start_time(*args, **kwargs)

def pending_sort_key(*args, **kwargs):
    return Utilities.pending_sort_key(*args, **kwargs)

def pending_seconds_until(*args, **kwargs):
    return Utilities.pending_seconds_until(*args, **kwargs)

def key_batch_from_enc_list(*args, **kwargs):
    return Utilities.key_batch_from_enc_list(*args, **kwargs)

def encode_b64_text(*args, **kwargs):
    return Utilities.encode_b64_text(*args, **kwargs)

def decode_b64_text(*args, **kwargs):
    return Utilities.decode_b64_text(*args, **kwargs)

def validate_uuid_v4(*args, **kwargs):
    return Utilities.validate_uuid_v4(*args, **kwargs)

def format_key_comment(*args, **kwargs):
    return Utilities.format_key_comment(*args, **kwargs)

def qkd_key_comment_contains_marker(*args, **kwargs):
    return Utilities.qkd_key_comment_contains_marker(*args, **kwargs)

def parse_qkd_comment_hint(*args, **kwargs):
    return Utilities.parse_qkd_comment_hint(*args, **kwargs)
...
class KMEClient:
    """KME (Key Management Entity) HTTP client"""
    pass
...
class MACsecController:
    """MACsec keychain and CA operations"""
    pass

class MKASession:
    """MKA session state parsing and matching"""
    pass

class MasterOrchestrator:
    """Master orchestrator for link management"""
    pass

class PeerKeyRotation:
    """SSH key rotation for peer communication"""
    pass

class PeerTransport:
    """SSH/SCP operations to peer routers"""
    pass

class RuntimeManager:
    """Logging and runtime directory management"""
    pass

class SlaveOrchestrator:
    """Slave orchestrator for actions"""
    pass

class StateManager:
    """State file operations for link keychain state"""
    pass

class StatusExporter:
    """Peer status snapshots and exports"""
    pass
...
# ============================================================================
# KMEClient implementation: 2 methods
# ============================================================================
...
# ============================================================================
# LockManager implementation: 4 methods
# ============================================================================
...
# ============================================================================
# MACsecController implementation: 16 methods
# ============================================================================
...
# ============================================================================
# MKASession implementation: 8 methods
# ============================================================================
...
# ============================================================================
# MasterOrchestrator implementation: 5 methods
# ============================================================================
...
# ============================================================================
# PeerKeyRotation implementation: 6 methods
# ============================================================================
...
# ============================================================================
# PeerTransport implementation: 9 methods
# ============================================================================
...
# ============================================================================
# RuntimeManager implementation: 5 methods
# ============================================================================
...
# ============================================================================
# SlaveOrchestrator implementation: 6 methods
# ============================================================================
...
# ============================================================================
# StateManager implementation: 9 methods
# ============================================================================
...
# ============================================================================
# StatusExporter implementation: 3 methods
# ============================================================================
...
# ============================================================================
# Utilities implementation: 116 methods
# ============================================================================
