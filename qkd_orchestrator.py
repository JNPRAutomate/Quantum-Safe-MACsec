...
from inventory_builder import build_inventory, build_full_inventory
from pki import build_pki
from settings import CONFIG, PKI, QKD
from onbox_builder import build_onbox_artifacts
from provisioning import run_provisioning

from jnpr.junos import Device
from jnpr.junos.utils.scp import SCP
from qkd_identity import preflight_all_devices
from qkd_clean import handle_clean
import warnings
...
def handle_create(args):
    ...
    ca_cert = certs_dir / PKI["CA_CERT_NAME"]
