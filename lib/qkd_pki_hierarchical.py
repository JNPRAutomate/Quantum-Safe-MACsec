...
DEFAULT_PKI_CONFIG = BASE_DIR / "config" / "pki" / "pki.yml"
...
def build_hierarchical_pki(config_path=DEFAULT_PKI_CONFIG, clean=False, verify=False):
    ...
    if clean and output_dir.exists():
        ...
        print(f"OK removed: certs/dual_pki/ folder")
    ...
    if not devices_source:
        raise ValueError("Missing pki.devices_source in config/pki/pki.yml")
    ...
    print(f"Output directory: certs/dual_pki")
